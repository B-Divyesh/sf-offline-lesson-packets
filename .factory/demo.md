...
The demo starts with the realistic “Notice, wonder, connect” small-group
...
**Reset demo** clears the demo key and restores the sample. **Start for real**
discards the demo key and opens the real composer.
